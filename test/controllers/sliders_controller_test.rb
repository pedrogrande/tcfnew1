...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { button_text: @slider.button_text, button_url: @slider.button_url, content: @slider.content, image: @slider.image, priority: @slider.priority, title: @slider.title }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { button_text: @slider.button_text, button_url: @slider.button_url, content: @slider.content, image: @slider.image, priority: @slider.priority, title: @slider.title }
    assert_redirected_to slider_path(assigns(:slider))
  end
