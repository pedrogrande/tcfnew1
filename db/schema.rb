...
ActiveRecord::Schema.define(version: 20140211074004) do
  ...
  add_index "intake_enrolments", ["enrolment_id"], name: "index_intake_enrolments_on_enrolment_id"
  add_index "intake_enrolments", ["intake_id"], name: "index_intake_enrolments_on_intake_id"
  ...
  create_table "student_sites", force: true do |t|
    t.string   "name"
    t.string   "url"
    t.string   "image"
    t.string   "screenshot"
